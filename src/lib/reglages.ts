 ...
 * du serveur, lien Discord, ouverture du recrutement. Tout le reste (nom du
 * site, URL des API tierces, image Open Graph) demeure dans src/lib/site.ts,
 * parce que le modifier suppose de toucher au code de toute façon.
 */
